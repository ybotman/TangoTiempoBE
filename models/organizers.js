...
const organizerSchema = new mongoose.Schema({
  ...
  name: { type: String, required: true, default: "Change This" },
  fullName: { type: String, required: true, default: "Change This" },
  shortName: { type: String, required: true,  default: "Change This"},
