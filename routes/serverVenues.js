...
async function isDuplicateVenue(latitude, longitude, calculatedCityId, excludeId = null) {
  const query = {
    calculatedCityId: new mongoose.Types.ObjectId(calculatedCityId), // Scoped to the same city
    geolocation: {
      $near: {
...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    const newVenue = new Venue({
      ...
      calculatedCityId: cityInfo.cityId,
      calculatedDivisionId: cityInfo.divisionId,
      calculatedRegionId: cityInfo.regionId,
      calculatedCountryId: cityInfo.countryId,
