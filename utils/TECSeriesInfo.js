...
const xmlFilePath = './utils/XMLData4Cutover/bostontangocalendar.WordPress.2024-10-03.series.xml';
const outputFilePath = './utils/XMLData4Cutover/logs/SeriesInfo.json';
...
const categories = event.category ? event.category
    ...
    fs.writeFile(outputFilePath, JSON.stringify(sortedEventGroups, null, 2), (err) => {
      if (err) throw err;
      console.log('Series Info JSON has been saved.');
    });
  });
});